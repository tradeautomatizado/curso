...
class MainForm(WindowForm):
    ...
    def create(self):
        ...
        stock_data = self.parentApp.myDatabase.get_stock_by_bars(
    ...
    def update(self):
        ...
        """
        try:
            self.basic_stats.value = self.parentApp.myDatabase.account_info()
            self.positions.entry_widget.values = self.parentApp.myDatabase.list_opened_positions()

            self.parentApp.ask, self.parentApp.bid = self.parentApp.myDatabase.get_ask_bid(self.parentApp.stock)
